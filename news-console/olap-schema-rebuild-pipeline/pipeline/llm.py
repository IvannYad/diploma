"""OpenAI client wrapper used by schema validation and other LLM-driven rebuild steps."""
...
class LlmClient:
    """Provides JSON-mode chat completions for proposed-schema validation.
    ...
    def json_chat(self, system_prompt: str, user_prompt: str) -> dict[str, Any]:
        ...
        Args:
            ...
            user_prompt: User role payload (schema, sample tables, etc.).
